...
class DQNAgent:
    ...
    def adjust_alpha_beta(self, epoch_ratio):
        self.alpha = self.initial_alpha + (self.last_alpha - self.initial_alpha) * epoch_ratio
        self.beta = self.initial_beta + (self.last_beta - self.initial_beta) * epoch_ratio
...
def main():
    ...
    for epoch in range(EPOCHS):
        ...
        state, _ = env.reset()
        agent.adjust_alpha_beta(epoch / EPOCHS)
